...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">I am a creative designer and frontend developer based in Magetan, East Java - Indonesia. I am very passionate and dedicated to my work</p>
